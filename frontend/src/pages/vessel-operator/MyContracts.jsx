...
const ContractDetailModal = ({ contract, onClose, onAccept, onDecline, isActioning }) => {
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium">{contract.energyAmount} kWh</span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-bold text-emerald-700">{formatCurrency(contract.totalValue)}</span>
          </div>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Review and respond to DR event contracts assigned to your vessels.
          </p>
        </div>
